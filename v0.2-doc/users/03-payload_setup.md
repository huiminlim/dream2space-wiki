# Appendix - Setting up the Payload Manager's SD Card
...
Setup and operations was tested on a PC that runs on Windows 10.
...
3. Login to the Raspberry Pi when prompted.
    ...
    ![SSH login success](images/ssh_success.png)
